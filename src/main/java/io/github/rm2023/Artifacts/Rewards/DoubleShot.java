...
public class DoubleShot extends Passive {
    ...
    public String getDescription() {
        return "Fire two arrows in rapid sequence.";
    }

    @Override
    public ItemStack getRepresentationStack() {
        ItemStack item = new ItemStack(Material.TIPPED_ARROW, 2);
    ...
    public void DoubleShotEvent(EntityShootBowEvent event) {
